...
class AddHealthInstitution extends StatefulWidget {
  @override
  _AddHealthInstitutionState createState() => _AddHealthInstitutionState();
}

class _AddHealthInstitutionState extends State<AddHealthInstitution> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("addHealthInstitution").tr(),
      ),
      body: Container(
        child: Padding(
  ...
  addInstitution() {
    dio.post("/health_institution", data: {
      ...
      if (response.statusCode == 200) {
        Toast.show("additionSuccessful".tr(), context);
