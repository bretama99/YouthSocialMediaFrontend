...
final List<Category> categories = [
  Category(9,"HIV", icon: FontAwesomeIcons.globeAsia),
  Category(10,"Sexual Reproduction Health", icon: FontAwesomeIcons.bookOpen),
  Category(11,"Addiction", icon: FontAwesomeIcons.monument),
  Category(12,"Music", icon: FontAwesomeIcons.carAlt),
