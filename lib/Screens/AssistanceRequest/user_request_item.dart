...
class UserRequestItem extends StatelessWidget {
  final UserAssistanceRequest assistanceRequest;
  final utility = new Utility();

  UserRequestItem(this.assistanceRequest);
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(utility.processDate(
                          DateTime.parse(assistanceRequest.createdAt))),
                    ),
                  ],
                ),
              ],
